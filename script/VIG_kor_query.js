...
var inner_c_00 = 150,
    ...
    inner_c_duration_08 = 200,//linear ver
    ...
    if(height<800){        
        ...
        $.each(btn_dn, function(key, value){ 
            if(key==0){
                ...
                $(value).find('img').attr("src", "img/down_in_welcome_kr.png");                 
            }else{
        ...
        $.each(btn_dn, function(key, value){ 
            if(key==0){
                ...
                $(value).find('img').attr("src", "img/down_"+key+"_kr.png")   
            }else{
...
$.each(btn_dn, function(key, value){
    $(value).off('click').on('click',function(){
        ...
        contentsMoveInit("#contentsBox_"+key, 0.0, 150, 1000, 'easeInQuad', 'easeOutExpo', '+');
        jumpPageNumber++;
        if(jumpPageNumber>8) jumpPageNumber = 8;
    });
});
...
document.querySelector('#launch_52').addEventListener('mouseover', () => {
    document.querySelector('#blink_31').style.opacity = 1;
})
document.querySelector('#launch_52').addEventListener('mouseleave', () => {
    document.querySelector('#blink_31').style.opacity = 0;
})
